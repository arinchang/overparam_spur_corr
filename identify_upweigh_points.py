...
def topk_embeddings_mask(non_min_embeds, avg_minority_embed, k, idx, num_points):
    ...
    topk_idx = torch.topk(dists, k, dim=0)[1] # TODO just testing for now 
...
def main():
    ...
    non_min_embeds = non_min_embeds.resize(19782, 2048)
    ...
    # sampler = WeightedRandomSampler(new_weights, ___)
    # DataLoader(sampler)
